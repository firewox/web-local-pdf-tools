    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        <select
          ...
          className="chip-btn appearance-none pr-8 text-sm font-medium cursor-pointer"
          title={t('language')}
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none text-ink-faint">
