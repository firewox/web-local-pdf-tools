...
const resources = {
  en: {
    translation: {
      ...
      "organizeGridHint": "Click a page to view it large · tick to select · drag to reorder",
      "mergeGridHint": "Click a page to view it large · drag to reorder · hover to rotate",
      "totalPagesCount": "{{count}} pages total",
      "sourcePageLabel": "{{name}} · page {{page}}",
      "mergeSourcesLabel": "{{count}} document(s)",
  ...
  zh: {
    translation: {
      ...
      "organizeGridHint": "点击看大图 · 勾选选中 · 拖拽排序",
      "mergeGridHint": "点击看大图 · 拖拽调整顺序 · 悬停可旋转",
      "totalPagesCount": "共 {{count}} 页",
      "sourcePageLabel": "{{name}} · 第 {{page}} 页",
      "mergeSourcesLabel": "{{count}} 个文档",
      "selectPage": "选中页面",
      "deselectPage": "取消选中",
      "restore": "恢复",
      "close": "关闭",
